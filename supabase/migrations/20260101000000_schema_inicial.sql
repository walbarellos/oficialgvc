...
CREATE UNIQUE INDEX IF NOT EXISTS idx_visitors_cpf_unique ON visitors (cpf) WHERE cpf IS NOT NULL AND cpf != '';
CREATE UNIQUE INDEX IF NOT EXISTS idx_visitors_passport_unique ON visitors (passport) WHERE passport IS NOT NULL AND passport != '';
